...
def tool_run_code(language: str, code: str) -> str:
    """Run code in an E2B sandbox. Falls back to simulated if no API key."""
    ...
    return (
        f"Code execution ({language}) [SIMULATED — set E2B_API_KEY for real execution]:\n"
        f"```{language}\n{code}\n```\n"
        "Output: Simulated run complete. No actual execution performed."
    )
